...
/**
 * Beváltja a nonce-ot: visszaadja a hozzá tartozó user_id-t, majd törli.
 * `null`, ha ismeretlen, lejárt, más szolgáltatóhoz tartozik, vagy már
 * felhasználták — mindhárom esetben a folyamatot el kell utasítani.
 */
